    ...
    <>
      <header class="pl-tabs">
        <nav class="pl-nav">
          ...
          <Link class="pl-nav-link" href="/next/app/offer" aria-current={location.url.pathname.includes('/app/offer') ? 'page' : undefined}>
            {t(i18n, 'offerTabLabel', 'Offer')}
          </Link>
          <Link class="pl-nav-link" href="/next/app/history" aria-current={location.url.pathname.includes('/app/history') ? 'page' : undefined}>
            {t(i18n, 'historyTabLabel', 'History')}
          </Link>
          <Link class="pl-nav-link" href="/next/app/settings" aria-current={location.url.pathname.includes('/app/settings') ? 'page' : undefined}>
            {t(i18n, 'settingsTabLabel', 'Settings')}
          </Link>
          <Link class="pl-nav-link" href="/next/app/help" aria-current={location.url.pathname.includes('/app/help') ? 'page' : undefined}>
