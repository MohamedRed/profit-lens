...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get analysisFailedQuotaBody =>
      'تحليل لقطة الشاشة غير متاح مؤقتًا. أدخل التفاصيل يدويًا ثم أعد المحاولة لاحقًا.';
  ...
  @override
  String get dropoffNameLabel => 'اسم المستلم';
  ...
  @override
  String get installAppSubtitle => 'أضف Liive Profit إلى الشاشة الرئيسية';
  ...
  String get installAppRequiredBody =>
      'للمتابعة، ثبّت Liive Profit ثم افتحه من الشاشة الرئيسية. سيتم عرض دليل التثبيت تلقائيًا.';

  @override
  String get installAppRequiredNativeBody =>
      'للمتابعة، ثبّت Liive Profit ثم افتحه من الشاشة الرئيسية. اضغط على تثبيت لفتح نافذة التثبيت في المتصفح.';
